...
from src.repos.rules import RulesRepo, UserRulesRepo
...
class DBManager:
    ...
    async def __aenter__(self) -> Self:
        ...
        self.rules = RulesRepo(self.session)
        self.user_rules = UserRulesRepo(self.session)
        return self
