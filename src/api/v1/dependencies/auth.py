...
def _validate_token_type(
    payload: dict, expected_type: TokenType
):
...
UidByAccess = Annotated[
    int, Depends(resolve_token_by_type(TokenType.ACCESS))
]
UidByRefresh = Annotated[
